                ...
                <div class="ctn-highlight-cards d-flex flex-wrap gap-3 mt-3">
                    <div class="ctn-card col">
                        <div class="card card-highlight">
                            <div class="info-dia card-body">
                                <h5 class="card-title">Pedidos em aberto</h5>
                                <p class="card-text abertos-qtd display-md-4">0</p>
                            </div>
                        </div>
                    </div>
                    <div class="ctn-card col">
                        <div class="card card-highlight">
                            <div class="info-dia card-body">
                                ...
                                <p class="card-text separados-qtd display-md-4">0</p>
                            </div>
                        </div>
                    </div>
                    <div class="ctn-card col">
                        <div class="card card-highlight">
                            <div class="info-dia card-body">
                                ...
                                <p class="card-text enviados-qtd">0</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="pedidoModal" tabindex="-1" aria-labelledby="pedidoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-pedido">
                ...
                <div class="modal-footer p-0">
                    <button type="button" class="btn btn-secondary w-100 m-0 p-1 m-2 rounded" data-bs-dismiss="modal">Fechar</button>
                </div>
        ...
        <script>
            ...
            $('.box-pedido').on('click', function(){
                const codigoPedido = $(this).attr('data-codigo');
                $('#pedidoModalLabel').text("Pedido: " + codigoPedido);
